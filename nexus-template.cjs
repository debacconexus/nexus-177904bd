...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Medical AI False-Positive Governance Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Biomarker Prediction Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "biomarker_prediction_case_records";
'use strict';
